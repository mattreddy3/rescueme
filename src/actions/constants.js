...
export const DATA = 'DATA' // data placeholder type

// Action prefix templates
export const FETCH_ = 'FETCH_' // fetch prefix
export const CREATE_ = 'CREATE_'
export const DELETE_ = 'DELETE_'
export const INSERT_ = 'INSERT_'
export const UPDATE_CURRENT_ = 'UPDATE_CURRENT_'
...
export const _LOADING_FAILED = '_LOADING_FAILED'
